...
class F331EmployeeSalarySlipReport extends Component {
  constructor(props) {
    super(props);
    this.state = {
      isLoading: false,
  ...
  render() {
    ...
    const columns = [
      ...
      //     return (
      //       <>
      //         {rowData.paymentThrough === "Cheque" ? (
      //           <div>{rowData.paymentThrough}</div>
      //         ) : (
      //           <div
      //             style={{
      //               display: "flex",
          ...
          return (
            <>
              <Link
                ...
                to={`/dashboard/F331GeneratedSalarySlip/${this.state.academicSessionId}T${this.state.monthId}T${this.state.employeeObject}T${this.state.yearId}`}
              >
                Print
              </Link>
            </>
    ...
    return (
      <Fragment>
        ...
        <div className={classes.mainContainer}>
          ...
          <Grid item xs={12}>
            <F331EmployeeSalarySlipReportTableComponent
              columns={columns}
              data={this.state}
            />
          </Grid>
...
F331EmployeeSalarySlipReport.propTypes = {
  classes: PropTypes.object,
  setDrawerOpen: PropTypes.func,
};

F331EmployeeSalarySlipReport.defaultProps = {
  classes: {},
  setDrawerOpen: (fn) => fn,
};
export default withStyles(styles)(F331EmployeeSalarySlipReport);
