...
import { SortAscending } from "mdi-material-ui";

class F87ReportsTableComponent extends Component {
	constructor(props) {
		super(props);
		...
		this.state = {
			...
			defaultSorting: [{ columnName: "sortOrder", direction: "asc" }],
			...
			tableColumnExtensions: [
				...
				{ columnName: "studentNucleusId", width: 100 },
				{ columnName: "studentLabel", wordWrapEnabled: true },
				{ columnName: "label", wordWrapEnabled: true },
				{ columnName: "sortOrder", width: 100 },
		...
		return (
			<Paper style={{ height: `${containerHeight}px` }}>
				...
				>
					...
					<GroupingState
						grouping={[{ columnName: 'studentNucleusId' }]}
...
F87ReportsTableComponent.propTypes = {
...
F87ReportsTableComponent.defaultProps = {
	columns: [],
	rows: [],
	showFilter: false,
...
export default F87ReportsTableComponent;
