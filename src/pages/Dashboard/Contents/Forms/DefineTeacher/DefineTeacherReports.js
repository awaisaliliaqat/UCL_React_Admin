...
import DefineTeacherReportsTableComponent from "./Chunks/DefineTeacherReportsTableComponent";
                ...
                <div style={{
                    ...
                    <div style={{
                        ...
                        <Typography style={{ color: '#1d5f98', fontWeight: 600, textTransform: 'capitalize' }} variant="h5">
                            <Tooltip title="Back">
                                <IconButton onClick={() => window.location.replace('#/dashboard/define-teachers/0')}>
                    ...
                    <DefineTeacherReportsTableComponent
