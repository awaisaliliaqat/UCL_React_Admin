...
class F360ReportsTableComponent extends Component {
...
F360ReportsTableComponent.propTypes = {
    columns: PropTypes.array,
    rows: PropTypes.array,
    showFilter: PropTypes.bool
}

F360ReportsTableComponent.defaultProps = {
    columns: [],
    rows: [],
    showFilter: false
}

export default F360ReportsTableComponent;
