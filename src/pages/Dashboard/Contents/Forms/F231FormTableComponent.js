...
class F231FormTableComponent extends Component {
  constructor(props) {
    super(props);
    this.state = {
      columns: [
...
export default F231FormTableComponent;

F231FormTableComponent.propTypes = {
  showFilter: PropTypes.bool,
};

F231FormTableComponent.defaultProps = {
  showFilter: true,
};
