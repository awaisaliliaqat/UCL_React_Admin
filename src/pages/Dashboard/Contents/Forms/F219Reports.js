...
import F219ReportsTableComponent from "./F219ReportsTableComponent";
...
class F219Reports extends Component {
  constructor(props) {
    super(props);
    this.state = {
      isLoading: false,
            ...
            for (var i=0; i<dataLength; i++) {
              json.DATA[i].action = (
                <EditDeleteTableRecord
                  ...
                  onEditURL={`#/dashboard/F219Form/${data[i].id}`}
  ...
  DeleteData = async (event) => {
    ...
    const url = `${process.env.REACT_APP_API_DOMAIN}/${process.env.REACT_APP_SUB_API_NAME}/common/C219CommonFeedbackSetupDelete`;
    await fetch(url, {
      method: "POST",
      body: data,
      headers: new Headers({
