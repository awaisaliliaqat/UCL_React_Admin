...
class F67ReportsTableComponent extends Component {
  constructor(props) {
    super(props);
    this.state = {
      columns: [],
      ...
      sortingStateColumnExtensions: [
        ...
        { columnName: "courseContentPopup", sortingEnabled: false }
      ],
      tableColumnExtensions: [
        { columnName: "SRNo", width:100},
        { columnName: "label", wordWrapEnabled: true },
        { columnName: "sectionLabel", wordWrapEnabled: true },
        { columnName: "createdOnReport", width:180},
        { columnName: "courseContentPopup", width:120, align:"center" },
      ...
      filteringStateColumnExtensions: [
        ...
        { columnName: "courseContentPopup", filteringEnabled: false }
      ],
    };
  }
...
export default F67ReportsTableComponent;
