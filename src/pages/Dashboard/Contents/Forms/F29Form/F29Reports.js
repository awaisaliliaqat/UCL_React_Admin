...
import AssignSectionToTeacherReportsTableComponent from "./Chunks/AssignSectionToTeacherReportsTableComponent";

class AssignSectionToTeacherReports extends Component {
                ...
                <div style={{
                    ...
                    <div style={{
                        ...
                        <Typography style={{ color: '#1d5f98', fontWeight: 600, textTransform: 'capitalize' }} variant="h5">
                            <Tooltip title="Back">
                                <IconButton onClick={() => window.location.replace('#/dashboard/assign-section-to-teacher/0')}>
                    ...
                    <AssignSectionToTeacherReportsTableComponent
...
export default AssignSectionToTeacherReports;