...
class F18FormPopupComponent extends Component {
  constructor(props) {
    super(props);
    console.log(props);
    this.state = {
  ...
  saveCopyToNext = async () => {
    ...
    data.append("academicsSessionId", this.state.toSessionId);

    const url = `${process.env.REACT_APP_API_DOMAIN}/${process.env.REACT_APP_SUB_API_NAME}/academics/C18CommonAcademicSessionsCopyToNext`;
    await fetch(url, {
      method: "POST",
      body: data,
      headers: new Headers({
        ...
        >
          ...
          <DialogActions>
            ...
            <Button
              ...
              color="primary"
              disabled={this.state.toSessionId === ""}
            >
              Save
            </Button>
          </DialogActions>
...
F18FormPopupComponent.propTypes = {
...
F18FormPopupComponent.defaultProps = {
  dialogTitle: "",
  isReadOnly: true,
};

export default withStyles(styles)(F18FormPopupComponent);
