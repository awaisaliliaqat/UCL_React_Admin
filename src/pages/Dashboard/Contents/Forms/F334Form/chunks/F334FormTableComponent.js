...
const F334FormTableComponent = (props) => {
  ...
  const [currencyColumns] = useState(["ratePerHour","hourlyAmount","perMonthSalary","deductionAmount", "overTimeAmount"]);
...
F334FormTableComponent.propTypes = {
...
F334FormTableComponent.defaultProps = {
  data: {},
  columns: [],
  expandedGroups: [],
  showFilter: false,
...
export default F334FormTableComponent;
