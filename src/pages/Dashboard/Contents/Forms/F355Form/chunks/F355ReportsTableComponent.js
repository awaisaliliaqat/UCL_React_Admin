...
const F355ReportsTableComponent = (props) => {
...
F355ReportsTableComponent.propTypes = {
	rows: PropTypes.array,
	columns: PropTypes.array
};

F355ReportsTableComponent.defaultProps = {
	rows: [],
	columns: []
};

export default F355ReportsTableComponent;
