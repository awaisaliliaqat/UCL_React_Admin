...
class F72ReportsTableComponent extends Component {
  constructor(props) {
    super(props);
    ...
    this.state = {
      ...
      sortingStateColumnExtensions: [
        { columnName: "programmeGroupLabels", filteringEnabled: false },
        { columnName: "action", sortingEnabled: false },
      ],
      tableColumnExtensions: [
        { columnName: "SRNo", width: 100 },
        { columnName: "userLabel", wordWrapEnabled: true },
        { columnName: "programmeGroupLabels", wordWrapEnabled: true },
...
export default F72ReportsTableComponent;
