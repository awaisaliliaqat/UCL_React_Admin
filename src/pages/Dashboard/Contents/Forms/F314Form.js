...
import F314FormTableComponent from "./F314FormTableComponent";
...
class F314From extends Component {
  constructor(props) {
    super(props);
    this.state = {
      isLoading: false,
                ...
                <Grid container spacing={2}>
                  ...
                  <Grid item xs={12} md={3}>
                    <TextField
                      ...
                      disabled={!this.state.academicSessionId || !!this.state.mainPagestudentNucleusId}
                    >
                  ...
                  <Grid item xs={12} md={3}>
                    <TextField
                      ...
                      disabled={!this.state.programmeGroupId || !!this.state.mainPagestudentNucleusId}
                      fullWidth
                      select
                    >
                  ...
                  */}
                  <Grid item xs={12} md={1}>
                    <Button
                      variant="contained"
                      color="primary"
                      disabled={ this.state.isLoading || this.state.isLoadingTableData || (!this.state.programmeId && this.state.sessionSortOrder>23 && !this.state.mainPagestudentNucleusId) }
...
export default  withStyles(styles)(F314From);
