...
class F306AnnouncementForEmployeeForm extends Component {
  ...
  getprogramGroups = async () => {
    ...
    const url = `${process.env.REACT_APP_API_DOMAIN}/${process.env.REACT_APP_SUB_API_NAME}/lms/C306CommonActiveSessionProgrammeGroupView`;
    await fetch(url, {
      method: "POST",
      headers: new Headers({
  ...
  loadUsersRolesTypes = async () => {
    this.setState({ isLoading: true });
    const url = `${process.env.REACT_APP_API_DOMAIN}/${process.env.REACT_APP_SUB_API_NAME}/lms/C306CommonUsersRolesTypesView`;
    await fetch(url, {
      method: "POST",
      headers: new Headers({
        Authorization: "Bearer " + localStorage.getItem("uclAdminToken"),
            ...
            >
              ...
              <Grid item xs={12} sm={6}>
                <DatePicker
                  ...
                  helperText={
                    this.state.anouncementDateError
                      ? this.state.anouncementDateError
                      : ""
                  }
                />
