...
class DefineTeacherReportsTableComponent extends Component {
...
DefineTeacherReportsTableComponent.propTypes = {
...
DefineTeacherReportsTableComponent.defaultProps = {
    columns: [],
    rows: [],
    showFilter: false
}

export default DefineTeacherReportsTableComponent;
