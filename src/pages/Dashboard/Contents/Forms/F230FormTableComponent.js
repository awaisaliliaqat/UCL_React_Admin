...
class F230FormTableComponent extends Component {
  constructor(props) {
    super(props);
    this.state = {
      columns: [
        ...
        { name: "classDate", title: "Class\xa0Date" },
        { name: "classTime", title: "Class\xa0Time" },
        { name: "classRoomLabel", title: "Room\xa0Label" },
        { name: "teacherName", title: "Teacher" },
        { name: "approvalStatus", title: "Status" },
      ...
      tableColumnExtensions: [
        ...
        { columnName: "classDate",wordWrapEnabled: true },
        { columnName: "classTime", wordWrapEnabled: true },
...
export default F230FormTableComponent;

F230FormTableComponent.propTypes = {
  showFilter: PropTypes.bool,
};

F230FormTableComponent.defaultProps = {
  showFilter: true,
};
