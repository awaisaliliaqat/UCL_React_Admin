...
import R218Report from "./Contents/Forms/R218Report";
        ...
        <Router>
          <Suspense fallback={<p>Loading...</p>}>
            <Switch>
              ...
              <SetRoute
                setValue={(value) => handleValueChange(value)}
                name="ManualClassEntry"
                exact
                path="/dashboard/ManualClassEntry/:recordId"
                component={ManualClassEntry}
              />
              <SetRoute
                setValue={(value) => handleValueChange(value)}
                name="F09Form"
