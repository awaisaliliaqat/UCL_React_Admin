...
class F230Form extends Component {
  constructor(props) {
    super(props);
    this.state = {
  ...
  loadAcademicSession = async () => {
    ...
    const url = `${process.env.REACT_APP_API_DOMAIN}/${process.env.REACT_APP_SUB_API_NAME}/common/C230CommonAcademicSessionsView`;
    await fetch(url, {
      method: "POST",
      headers: new Headers({
  ...
  loadProgrammeGroups = async (academicsSessionId) => {
    ...
    this.setState({ isLoading: true });
    const url = `${process.env.REACT_APP_API_DOMAIN}/${process.env.REACT_APP_SUB_API_NAME}/common/C230CommonAcademicsSessionsOfferedProgrammesView`;
    await fetch(url, {
      method: "POST",
      body: data,
      headers: new Headers({
  ...
  loadCourses = async (academicsSessionId, programmeGroupId) => {
    ...
    this.setState({ isLoading: true });
    const url = `${process.env.REACT_APP_API_DOMAIN}/${process.env.REACT_APP_SUB_API_NAME}/common/C230CommonAcademicSectionsExtraClassesBySessionIdAndProgrammeGroupId`;
    await fetch(url, {
      method: "POST",
      body: data,
      headers: new Headers({
...
export default withStyles(styles)(F230Form);
