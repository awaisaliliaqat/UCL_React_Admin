...
const F354FormTableComponent = ({isLoading, rows, columns}) => {
    
    const [tableColumnExtensions] = useState([
        { columnName: "leaveTypeLabel", align: "left", width: 175 },
        { columnName: "startOnDate", align: "left", width: 175 },
        { columnName: "endOnDate", align: "left", width: 175 },
        { columnName: "noOfDays", align: "left", width: 175 },
		{ columnName: "createdOn", align: "left", width: 175 },
...
F354FormTableComponent.propTypes = {
    rows: PropTypes.array,
    columns: PropTypes.array,
	isLoading: PropTypes.bool,
};

F354FormTableComponent.defaultProps = {
    rows: [],
    columns: [],
	isLoading: false,
};

export default F354FormTableComponent;