...
class F34ReportsTableComponentForCentricDashboard extends Component {
  constructor(props) {
    super(props);
...
F34ReportsTableComponentForCentricDashboard.propTypes = {
  data: PropTypes.array,
  columns: PropTypes.array,
  showFilter: PropTypes.bool
};

F34ReportsTableComponentForCentricDashboard.defaultProps = {
  data: [],
  columns: [],
  showFilter: false
};

export default F34ReportsTableComponentForCentricDashboard;
