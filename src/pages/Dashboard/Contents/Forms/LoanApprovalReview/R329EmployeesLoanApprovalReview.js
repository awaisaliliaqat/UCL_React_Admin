...
class R329EmployeesLoanApprovalReview extends Component {
  constructor(props) {
    super(props);
    this.state = {
      isLoading: false,
  ...
  getData = async () => {
    ...
    const url = `${process.env.REACT_APP_API_DOMAIN}/${process.env.REACT_APP_SUB_API_NAME}/payroll/C329CommonUsersEmployeesLoanView`;
    await fetch(url, {
      method: "POST",
      body: formData,
      headers: new Headers({
  ...
  handleApproveLoan = async (event, id) => {
    ...
    const url = `${process.env.REACT_APP_API_DOMAIN}/${process.env.REACT_APP_SUB_API_NAME}/payroll/C329CommonUsersEmployeesLoanStatusChange
`;
    await fetch(url, {
      method: "POST",
      body: data,
  ...
  render() {
    const columns = [
      ...
      { name: "recommendedOn", title: "Recommended By" },
      ...
      },
      {
        ...
        getCellValue: (rowData) => {
          ...
          return (
            ...
            >
              {rowData.isApproved === 1 || rowData.isApproved === 2 ? (
                ...
                <Link
                  ...
                  to={`/dashboard/F327DefineEmployeesLoan/${rowData.id}TisApproved`}
                >
          ...
          return (
            ...
            >
              <Button
                ...
                disabled={rowData.isApproved === 1 || rowData.isApproved === 2}
      ...
      // { name: "fromDate", title: "Created On" },
    ...
    return (
      <Fragment>
        ...
        >
          ...
          />
          <R329EmployeesLoanApprovalReviewTableComponent
...
export default R329EmployeesLoanApprovalReview;
