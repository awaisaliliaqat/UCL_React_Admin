...
const F353ReportsTableComponent = (props) => {
	
	const [tableColumnExtensions] = useState([
		{ columnName:"leaveTypeLabel", align:"left" },
		{ columnName:"startOnDate", align:"left", width:100 },
		{ columnName:"endOnDate", align:"left", width:100 },
	...
	const Cell = (props) => {
		...
		if (column.name === "statusChangedOn") {
...
F353ReportsTableComponent.propTypes = {
	rows: PropTypes.array,
	columns: PropTypes.array
};

F353ReportsTableComponent.defaultProps = {
	rows: [],
	columns: []
};

export default F353ReportsTableComponent;
