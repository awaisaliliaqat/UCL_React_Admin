...
class F321DefineEmployeesMonthlySalaryView extends Component {
  constructor(props) {
    super(props);
    this.state = {
      isLoading: false,
      ...
      .then(
        (json) => {
          if (json.CODE === 1) {
            ...
            columns[index]["colspan"] =
              uniqueAllowancesArray.length == 0
                ? 1
...
F321DefineEmployeesMonthlySalaryView.propTypes = {
  classes: PropTypes.object,
};

F321DefineEmployeesMonthlySalaryView.defaultProps = {
  classes: {},
};
export default withStyles(styles)(F321DefineEmployeesMonthlySalaryView);
