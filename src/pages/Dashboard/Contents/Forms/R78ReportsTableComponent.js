...
import { Grid, PagingPanel, Table, TableFilterRow, TableHeaderRow,
   } from "@devexpress/dx-react-grid-material-ui";

class R78ReportsTableComponent extends Component {
  constructor(props) {
    super(props);
    ...
    this.state = {
      ...
      tableColumnExtensions: [
        ...
        { columnName: "deactivationDate", wordWrapEnabled: true },
...
export default (R78ReportsTableComponent);
