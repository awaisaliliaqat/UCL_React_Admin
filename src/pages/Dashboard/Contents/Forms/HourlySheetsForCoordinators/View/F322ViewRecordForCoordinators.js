...
import F322ViewRecordForCoordinatorsTableComponent from "./chunks/F322ViewRecordForCoordinatorsTableComponent";
...
class F322ViewRecordForCoordinators extends Component {
  ...
  onSearchClick = async (e) => {
    ...
    const url = `${process.env.REACT_APP_API_DOMAIN}/${process.env.REACT_APP_SUB_API_NAME}/common/C322EmployeeHourlySheetApprovedView`;
    await fetch(url, {
      method: "POST",
      body: data,
      headers: new Headers({
