...
class F202Form extends Component {
  ...
  getAcademicSessions = async () => {
    ...
    const url = `${process.env.REACT_APP_API_DOMAIN}/${process.env.REACT_APP_SUB_API_NAME}/common/C202CommonAcademicSessionsView`;
    await fetch(url, {
      method: "POST",
      headers: new Headers({
  ...
  loadProgrammeGroups = async (academicSessionId) => {
    ...
    const url = `${process.env.REACT_APP_API_DOMAIN}/${process.env.REACT_APP_SUB_API_NAME}/common/C202CommonAcademicsSessionsOfferedProgrammesGroupView`;
    await fetch(url, {
      method: "POST",
      body: data,
      headers: new Headers({
  ...
  getTerms = async (academicsSessionId) => {
    ...
    const url = `${process.env.REACT_APP_API_DOMAIN}/${process.env.REACT_APP_SUB_API_NAME}/common/C202CommonAcademicsSessionsTermsView`;
    await fetch(url, {
      method: "POST",
      body: data,
      headers: new Headers({
  ...
  getTotalNoOfAssessment = async (academicsSessionId, programmeGroupId, termId) => {
    ...
    data.append("rubricId", 3);
    const url = `${process.env.REACT_APP_API_DOMAIN}/${process.env.REACT_APP_SUB_API_NAME}/common/C202CommonAcademicsSessionsEvaluationsTotalNoOfAssessmentView`;
    await fetch(url, {
      method: "POST",
      body: data,
      headers: new Headers({
  ...
  getMaxAssessmentNo = async (academicsSessionId, programmeGroupId, termId, sectionId) => {
    ...
    const url = `${process.env.REACT_APP_API_DOMAIN}/${process.env.REACT_APP_SUB_API_NAME}/common/C202CommonAcademicsSessionsEvaluationsMaxAssessmentNoView`;
    await fetch(url, {
      method: "POST",
      body: data,
      headers: new Headers({
  ...
  loadData = async (sectionId, id=0) => {
    ...
    data.append("evaluationTypeId", 2);
    this.setState({ isLoading: true });
    const url = `${process.env.REACT_APP_API_DOMAIN}/${process.env.REACT_APP_SUB_API_NAME}/common/C202CommonSectionsStudentsView`;
    await fetch(url, {
      method: "POST",
      body: data,
      headers: new Headers({
        ...
        <form id="myForm">
          <Grid container component="main" className={classes.root}>
            ...
            >
              ...
              <TextField type="hidden" name="evaluationTypeId" defaultValue={2}/>
