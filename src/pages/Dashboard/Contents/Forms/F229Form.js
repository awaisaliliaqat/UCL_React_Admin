        ...
        .then(
          (json) => {
            if (json.CODE === 1) {
              ...
              if (
                json.SYSTEM_MESSAGE ==
                "java.lang.Exception: Class Already Exists."
              ) {
          ...
          <form id="myForm">
            <Grid container justify="left" alignItems="center" spacing={2}>
              ...
              <Grid item xs={12} md={2}>
                <DatePicker
                  ...
                  onChange={(date) =>
                    this.handleDateChange(date, "scheduleDate")
                  }
                  label="Date"
                  style={{
                    marginRight: 5,
            ...
            >
              ...
              <input
                type="hidden"
                name="classRoomId"
                value={this.state.roomsId}
              />
              <input
                type="hidden"
                name="courseId"
                value={!this.state.courseId ? 0 : this.state.courseId.id}
              />
              ...
              <Grid item xs={12} md={3}>
                <Autocomplete
                  ...
                  renderInput={(params) => (
                    <TextField
                      error={!!this.state.roomsObjectError}
                      variant="outlined"
                      placeholder="Rooms"
                      {...params}
                    />
              ...
              <Grid item xs={12} md={2}>
                <TextField
                  ...
                  value={
                    isEmpty(this.state.roomsObject)
                      ? ""
                      : this.state.roomsObject.studentCapacity
                  }
                  variant="outlined"
                  fullWidth
              ...
              <Grid item xs={2} style={{ textAlign: "center" }}>
                <Button
                  disabled={this.state.isLoading || !this.state.sectionId}
                  variant="contained"
