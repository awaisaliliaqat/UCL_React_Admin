...
class F300FormTableComponent extends Component {
  constructor(props) {
    super(props);
    this.state = {
      columns: [
...
export default F300FormTableComponent;

F300FormTableComponent.propTypes = {
  showFilter: PropTypes.bool,
}

F300FormTableComponent.defaultProps = {
  showFilter: false,
}
