...
import F34ReportsFilter from "./F34ReportsFilter";
import TablePanel from "../../../../components/ControlledTable/RerenderTable/TablePanel";
import LoginMenu from "../../../../components/LoginMenu/LoginMenu";
import { format } from "date-fns";
import F34ReportsTableComponent from "./F34ReportsTableComponent";
...
class F34Reports extends Component {
  constructor(props) {
    super(props);
    this.state = {
      isLoading: false,
  ...
  render() {
    ...
    const columns = [
      ...
      { name: "startTimeReportWithAmPm", title: "Starts On" },
      { name: "dueDateReport", title: "Due\xa0Date" },
      { name: "endTimeReportWithAmPm", title: "Ends On" },
