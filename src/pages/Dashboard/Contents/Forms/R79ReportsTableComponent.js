...
class CancelClassesTableComponent extends Component {
    ...
    constructor(props) {
        ...
        this.state = {
            ...
            tableColumnExtensions: [
                { columnName: 'teacherEmail', wordWrapEnabled: true, width: 200 },
                ...
                { columnName: 'holiday', wordWrapEnabled: true, width: 170 },
                // { columnName: 'joinedOn', wordWrapEnabled: true, width: 170 },
            ...
            filteringStateColumnExtensions: [
                { columnName: 'isPresent', filteringEnabled: false },
            ]
        };
    }
...
CancelClassesTableComponent.propTypes = {
...
CancelClassesTableComponent.defaultProps = {
    columns: [],
    rows: [],
    showFilter: false
}

export default CancelClassesTableComponent;
