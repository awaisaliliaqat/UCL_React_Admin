...
class ClassScheduleTableComponent extends Component {
...
ClassScheduleTableComponent.propTypes = {
...
ClassScheduleTableComponent.defaultProps = {
    columns: [],
    rows: [],
    showFilter: false
}

export default ClassScheduleTableComponent;
