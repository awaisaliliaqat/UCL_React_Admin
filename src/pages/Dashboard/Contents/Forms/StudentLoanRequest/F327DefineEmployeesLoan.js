...
class F327DefineEmployeesLoan extends Component {
  constructor(props) {
    super(props);
    this.state = {
      recordId: 0,
...
F327DefineEmployeesLoan.propTypes = {
  isDrawerOpen: PropTypes.bool,
  classes: PropTypes.object.isRequired,
  match: PropTypes.object,
};

F327DefineEmployeesLoan.defaultProps = {
  isDrawerOpen: true,
  match: {
    params: {
      recordId: 0,
...
export default withRouter(withStyles(styles)(F327DefineEmployeesLoan));
