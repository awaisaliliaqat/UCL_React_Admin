...
class F332EmployeeTaxCertificateReport extends Component {
  constructor(props) {
    super(props);
    this.state = {
      isLoading: false,
    ...
    return (
      <Fragment>
        ...
        <div className={classes.mainContainer}>
          ...
          <Grid item xs={12}>
            <F332EmployeeTaxCertificateReportTableComponent
              columns={columns}
              data={this.state}
            />
          </Grid>
...
F332EmployeeTaxCertificateReport.propTypes = {
  classes: PropTypes.object,
  setDrawerOpen: PropTypes.func,
};

F332EmployeeTaxCertificateReport.defaultProps = {
  classes: {},
  setDrawerOpen: (fn) => fn,
};
export default withStyles(styles)(F332EmployeeTaxCertificateReport);
