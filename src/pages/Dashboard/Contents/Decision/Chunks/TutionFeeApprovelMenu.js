...
const TutionFeeApprovelMenu = props => {
            ...
            <Dialog fullWidth={false}
                ...
                <DialogContent>
                    ...
                    <div className={classes.imageContainer} style={{
                        backgroundImage: `url(${process.env.REACT_APP_API_DOMAIN}/${process.env.REACT_APP_SUB_API_NAME}/academics/C12FinanceStudentsLegacyFeeImageView?fileName=${data.paymentFileName})`,
                    }} />
...
TutionFeeApprovelMenu.propTypes = {
...
TutionFeeApprovelMenu.defaultProps = {
    handleClose: fn => fn,
...
export default TutionFeeApprovelMenu;