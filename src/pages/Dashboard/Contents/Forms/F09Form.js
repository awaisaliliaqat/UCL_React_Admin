...
import { TextField, Grid, MenuItem, CircularProgress, Divider, Typography, Chip, Select, IconButton, Tooltip, Checkbox, Fab, Table, TableBody, TableCell, TableContainer, TableHead, TableRow, Paper, } from "@material-ui/core";
...
import F09FormPopupComponent from "./F09FormPopupComponent";
...
function CourseRow(props) {
	...
	return (
		<StyledTableRow key={rowData}>
			...
			<StyledTableCell align="center">{cCredit}</StyledTableCell>
			<StyledTableCell align="center">
