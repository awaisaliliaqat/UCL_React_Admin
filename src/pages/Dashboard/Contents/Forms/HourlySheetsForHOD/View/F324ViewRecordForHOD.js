...
import F322ViewRecordForCoordinatorsTableComponent from "./chunks/F324ViewRecordForHODTableComponent";
...
class F322ViewRecordForCoordinators extends Component {
  constructor(props) {
    super(props);
    this.state = {
      isLoading: false,
  ...
  onSearchClick = async (e) => {
    ...
    const url = `${process.env.REACT_APP_API_DOMAIN}/${process.env.REACT_APP_SUB_API_NAME}/common/C324EmployeeHourlySheetApprovedView`;
    await fetch(url, {
      method: "POST",
      body: data,
      headers: new Headers({
  ...
  onApproveClick = async (e) => {
    ...
    this.setState({ isLoading: true });
    const url = `${process.env.REACT_APP_API_DOMAIN}/${process.env.REACT_APP_SUB_API_NAME}/payroll/C324TeachersProgrammeGroupAttandanceAprrovalSave`;
    var data = new FormData();
        ...
        <div className={classes.mainContainer}>
          <div className={classes.titleContainer}>
            <Typography className={classes.title} variant="h5">
              ...
              {"Hourly Sheet For Head Of Department"}
              <br />
            </Typography>
          </div>
          ...
          <Grid item xs={12}>
            <F322ViewRecordForCoordinatorsTableComponent
              columns={columns}
              data={this.state}
            />
          </Grid>
...
F322ViewRecordForCoordinators.propTypes = {
  classes: PropTypes.object,
  setDrawerOpen: PropTypes.func,
};

F322ViewRecordForCoordinators.defaultProps = {
  classes: {},
  setDrawerOpen: (fn) => fn,
};
export default withRouter(withStyles(styles)(F322ViewRecordForCoordinators));
