...
class F201Reports extends Component {
  ...
  getData = async (status) => {
    ...
    const url = `${process.env.REACT_APP_API_DOMAIN}/${process.env.REACT_APP_SUB_API_NAME}/common/C201CommonAcademicsSessionsSubjectiveEvaluationsView`;
    await fetch(url, {
      method: "POST",
      headers: new Headers({
