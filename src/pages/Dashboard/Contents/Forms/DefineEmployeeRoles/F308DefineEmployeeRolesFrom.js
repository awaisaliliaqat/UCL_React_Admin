...
import DefineEmployeeRolesTableComponent from "./chunks/DefineEmployeeRolesTableComponent";
...
class F308DefineEmployeeRolesFrom extends Component {
  constructor(props) {
    super(props);
    this.state = {
  ...
  getEmployeeRolesTypesData = async (id) => {
    ...
    const url = `${process.env.REACT_APP_API_DOMAIN}/${process.env.REACT_APP_SUB_API_NAME}/common/C308CommonEmployeesRolesTypesView`;
    await fetch(url, {
      method: "POST",
      body: data,
      headers: new Headers({
  ...
  onFormSubmit = async (e) => {
    ...
    if (this.isFormValid) {
      ...
      this.setState({ isLoading: true });
      const url = `${process.env.REACT_APP_API_DOMAIN}/${process.env.REACT_APP_SUB_API_NAME}/common/C308CommonEmployeesRolesTypesSave`;
      await fetch(url, {
        method: "POST",
        body: data,
        headers: new Headers({
  ...
  onDeleteRecord = async (e, id) => {
    e.preventDefault();
      ...
      data.append("id", id);
      this.setState({ isLoading: true });
      const url = `${process.env.REACT_APP_API_DOMAIN}/${process.env.REACT_APP_SUB_API_NAME}/common/C308CommonEmployeesRolesTypesDeleteById`;
      await fetch(url, {
        method: "POST",
        body: data,
        headers: new Headers({
            ...
            <Grid container spacing={2} className={classes.reportsContainer}>
              <Grid item xs={12}>
                ...
                <DefineEmployeeRolesTableComponent
                  rows={this.state.employeeRolesData || []}
                  columns={columns}
...
F308DefineEmployeeRolesFrom.propTypes = {
...
F308DefineEmployeeRolesFrom.defaultProps = {
  isDrawerOpen: true,
  setDrawerOpen: (fn) => fn,
  match: {
    params: {
...
export default withStyles(styles)(F308DefineEmployeeRolesFrom);
