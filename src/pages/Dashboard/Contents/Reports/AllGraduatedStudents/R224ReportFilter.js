...
const R224ReportFilter = props => {
    const classes = useStyles();
    const { values, onHandleChange, getDataByStatus, onClearFilters, isLoading, onHandleChangeAS, onHandleChangePG, onHandleChangeProgramme, onHandleChangeDegreeClassification} = props;
        ...
        <Fragment>
            <div className={classes.container}>
                ...
                <div className={classes.item} style={{
                    ...
                    <span className={classes.label}> Degree Classification</span>
                    <TextField
                      id=" degreeClassification"
                      name="degreeClassification"
                      variant="outlined"
                      value={values.degreeClassificationId}
                      InputProps={{ classes: { input: classes.resize } }}
                      onChange={e => {
                    ...
                    //   helperText={values.academicSessionIdError}
                      select
                    >
                      {values.degreeClassificationMenuItems.map((dt, i) => (
                        <MenuItem
                          key={"degreeClassificationMenuItems"+dt.id}
                          value={dt.id}
                        >
                          {dt.label}
                        </MenuItem>
...
export default R224ReportFilter;