...
class F30FormPopupComponent extends Component {
    ...
    isPreCoursesValid = () => {
        ...
        if (this.state.preCourses.length<1) {
            ...
            this.setState({preCoursesError:"Max selected courses not more then two."});
            document.getElementById("preCourses").focus();
            isValid = false;
        } else {
                            ...
                            >
                                    ...
                                    <Autocomplete
                                        ...
                                        renderInput={(params) => (
                                            <TextField 
                                                ...
                                                helperText={this.state.preCoursesError?this.state.preCoursesError:<Typography color="primary" variant="caption">Max selection of courses should be two.</Typography>}
                                            />
                                        )}
                                    />
                                </Grid>
                                <Grid item xs={12} md={3}>
                                    <TextField
                                        ...
                                        helperText={this.state.preMarksError?this.state.preMarksError:" "}
                                    />
                                </Grid>
