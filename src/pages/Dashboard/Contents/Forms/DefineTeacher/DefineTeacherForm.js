...
class DefineTeacherForm extends Component {
                ...
                json => {
                    if (json.CODE === 1) {
                        ...
                        if (this.state.recordId == 0) {
                            ...
                            setTimeout(() => {
                                window.location.replace('#/dashboard/teacher-reports');
                            }, 1000);
                        }
                    } else {
                        this.handleOpenSnackbar(json.USER_MESSAGE + '\n' + json.SYSTEM_MESSAGE, "error");
    ...
    viewReport = () => {
        window.location = "#/dashboard/teacher-reports";
    }
...
DefineTeacherForm.defaultProps = {
    isDrawerOpen: true,
    match: {
        params: {
            recordId: 0
...
export default withStyles(styles)(DefineTeacherForm);