...
class F361FormTableComponent extends Component {
    ...
    constructor(props) {
        ...
        this.state = {
            ...
            tableColumnExtensions: [
                { columnName:'id', align:"left", width: 75 },
                ...
                { columnName:'fromDate', align:"center", width:95, wordWrapEnabled: true },
...
F361FormTableComponent.propTypes = {
    columns: PropTypes.array,
    rows: PropTypes.array,
    showFilter: PropTypes.bool
}

F361FormTableComponent.defaultProps = {
    columns: [],
    rows: [],
    showFilter: false
}

export default F361FormTableComponent;
