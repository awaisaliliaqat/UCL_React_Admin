            ...
            .then(
                json => {
                    if (json.CODE === 1) {
                        ...
                        this.props.handleOpenSnackbar(json.USER_MESSAGE + '\n' + json.SYSTEM_MESSAGE,"error");
                    }
                ...
                >
                    ...
                    <DialogContent>
                        <DialogContentText>
                            ...
                            >
                                <Grid item xs={12} md={4}>
                                    <TextField type="hidden" id="sectionId" name="sectionId" value={this.props.sectionId}/>
                                    <TextField
                                        id="preDay"
                                        name="preDay"
                                        variant="outlined"
                                        ...
                                        helperText={this.state.preDayError?this.state.preDayError:" "}
                                        required
                                        fullWidth
                                        select
                                        >
                                ...
                                <Grid item xs={12} md={4}>
                                    <TextField
                                        ...
                                        helperText={this.state.preTimeStartError?this.state.preTimeStartError:" "}
                                        required
                                        fullWidth
                                        select
                                        >
                                ...
                                <Grid item xs={12} md={3}>
                                    <TextField
                                        ...
                                        helperText={this.state.preTimeDurationError?this.state.preTimeDurationError:" "}
                                    />
                                </Grid>
                    ...
                    <DialogActions>
                        ...
                        <Button onClick={this.props.clickOnFormSubmit()} color="primary" autoFocus>
                            Save
                        </Button>
                    </DialogActions>
                </Dialog>
