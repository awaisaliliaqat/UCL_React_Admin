...
const F339AddManualAttendancesTableComponent = (props) => {
  ...
  const rows = data.employeePayrollsData || [];
  return (
    <Paper>
...
F339AddManualAttendancesTableComponent.propTypes = {
...
F339AddManualAttendancesTableComponent.defaultProps = {
  data: {},
  columns: [],
  expandedGroups: [],
  showFilter: false,
...
export default F339AddManualAttendancesTableComponent;
