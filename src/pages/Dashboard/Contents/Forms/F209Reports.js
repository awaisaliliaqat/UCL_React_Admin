...
import F209ReportsTableComponent from "./F209ReportsTableComponent";
...
class F209Reports extends Component {
  constructor(props) {
    super(props);
    this.state = {
      isLoading: false,
            ...
            for (var i=0; i<dataLength; i++) {
              json.DATA[i].action = (
                <EditDeleteTableRecord
                  ...
                  onEditURL={`#/dashboard/F209Form/${data[i].academicsSessionId}`}
