...
class AssignSectionToTeacherReportsTableComponent extends Component {
...
AssignSectionToTeacherReportsTableComponent.propTypes = {
...
AssignSectionToTeacherReportsTableComponent.defaultProps = {
    columns: [],
    rows: [],
    showFilter: false
}

export default AssignSectionToTeacherReportsTableComponent;
