            ...
            { name: "Email", dataIndex: "email", sortable: false, customStyleHeader: { width: '20%' } },
            {
                name: "Action", renderer: rowData => {
                    ...
                    return (
                        ...
                        }} variant="outlined" onClick={() => window.open(`#/view-student-profile/${rowData.studentId}`, "_blank")} >
                            View Profile
                        </Button>
                    )
        ...
        return (
            <Fragment>
                ...
                <div style={{
                    ...
                    <StudentProfileFilter isLoading={this.state.isLoading} onClearFilters={this.onClearFilters} values={this.state} getDataByStatus={() => this.getData()} onHandleChange={e => this.onHandleChange(e)} />
                    <div style={{
                        marginTop: 15,
                        marginBottom: 15,
                        color: '#174A84',
