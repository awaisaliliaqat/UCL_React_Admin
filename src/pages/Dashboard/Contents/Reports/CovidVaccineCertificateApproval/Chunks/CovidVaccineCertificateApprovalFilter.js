...
const AddmissionDecisionFilter = props => {
    ...
    const { values, onHandleChange, getDataByStatus, onClearFilters, isLoading, onHandleChangeAS, onHandleChangePG, onHandleChangeProgramme ,onHandleChangeStatus } = props;
            ...
            <div className={classes.container}>
                ...
                <div className={classes.item} style={{
                    ...
                    <TextField
                      ...
                      select
                    >
                      {values.statusMenuItems.map((dt, i) => (
                        <MenuItem
                          key={"statusMenuItems"+dt.id}
                          value={dt.id}
                        >
                          {dt.label}
                        </MenuItem>
