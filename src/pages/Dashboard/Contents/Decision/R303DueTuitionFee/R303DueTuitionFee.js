...
class R303DueTuitionFee extends Component {
    ...
    render() {
        const columns = [
            ...
            { name: "Status", renderer: rowData => { return ( <Fragment><div style={{color:'Red'}}>Over Due</div></Fragment> )}, dataIndex: "statusLabel", sortIndex: "statusLabel", sortable: true, customStyleHeader: { width: '12%', color:'Red' } },
            // {
