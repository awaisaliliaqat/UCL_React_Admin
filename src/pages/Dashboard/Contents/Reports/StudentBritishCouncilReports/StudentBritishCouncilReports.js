...
class StudentBritishCouncilReports extends Component {
    ...
    downloadExcelData = async () => {
        if (this.state.isDownloadExcel === false) {
            ...
            const url = `${process.env.REACT_APP_API_DOMAIN}/${process.env.REACT_APP_SUB_API_NAME}/common/C226CommonStudentsExcelDownload?academicsSessionId=${this.state.academicSessionId}&programmeId=${this.state.programmeId}`;
            await fetch(url, {
                method: "GET",
                headers: new Headers({
                ...
                .then(
                    json => {
                        if (json) {
                            ...
                            tempLink.setAttribute("download", `Student British Council Report.xlsx`);
    ...
    loadAcademicSessions = async () => {
        ...
        const url = `${process.env.REACT_APP_API_DOMAIN}/${process.env.REACT_APP_SUB_API_NAME}/common/C226CommonAcademicSessionsView`;
        await fetch(url, {
          method: "POST",
          headers: new Headers({
            Authorization: "Bearer " + localStorage.getItem("uclAdminToken"),
...
export default StudentBritishCouncilReports;