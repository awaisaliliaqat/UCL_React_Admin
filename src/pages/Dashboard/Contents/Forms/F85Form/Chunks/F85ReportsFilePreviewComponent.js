...
const F85ReportsFilePreviewComponent = ({ open, url, type, name, onClose, onDownload }) => {
	...
	return (
		...
		>
			<DialogTitle disableTypography style={{ display: "flex", alignItems: "center" }}>
				<Typography id="file-preview-title" variant="subtitle1" style={{ flex: 1, overflow: "hidden", textOverflow: "ellipsis", whiteSpace: "nowrap" }}>
					{name}
				</Typography>
...
export default F85ReportsFilePreviewComponent;
