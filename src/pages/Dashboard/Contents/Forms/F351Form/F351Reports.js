...
import F351ReportsTableComponent from "./F351ReportsTableComponent";
...
class F351Reports extends Component {
	constructor(props) {
		super(props);
		this.state = {
			isLoading: false,
	...
	render() {
		...
		const columns = [
			{ name: "srNo", title: "SR#" },
			{ name: "label", title: "Leave Type" },
			{ name: "defaultQuota", title: "Default Quota" },
...
export default withStyles(styles)(F351Reports);
